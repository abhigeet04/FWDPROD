...
<title>Forward Contract Checker Process without Rate</title>
...
<script>
	...
	function fetchCheckerDetails() {
		$("#myForm").attr("action", "checkerProcessWithoutRate");
		$("#myForm").submit();
	}
		...
		<div class="row">
			...
			<div class="col-md-10 content_box">
				...
				<h5 class="row fontcol" style="color: #527BB8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Forward Contract - Checker Process Without Rate</h5>
				<br /> <br />
							...
							<div class="col-md-6">
								...
								<div class="col-md-3" style="margin-left: 39%;">
									<input style="width: 50px" type="button" value="Search"
										class="button" onclick="fetchCheckerFwdcontractDetailsWithoutRate()" />
								</div>
																	...
																	<div class="form-group">
																		<c:choose>
																			<c:when test="${status=='PENDING FOR APPROVAL'}">
																				<input type="button" class="viewButtonWithoutRate" value="View"
																					style="width: 50px; margin: 5px" />
																				<input type="button" class="ApproveOrRejectButtonWithoutRate"
