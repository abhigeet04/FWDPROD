				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="col-md-5">
							<div class="form-group">
								<label class="col-md-5 Control-label"
									style="font-weight: normal;">Currency Code</label>
								<div class="col-md-4 input-group input-group-md">
									<gr:textfield id="currency" name="staticDataVo.currency"
						...
						<%-- 	<div class="col-md-5">
							<div class="form-group">
								<label class="col-md-5 Control-label"
									style="font-weight: normal;">currency Name</label>
								<div class="col-md-4 input-group input-group-md">
									<gr:textfield id="currencyFullName" name="staticDataVo.currencyFullName"
										cssClass="form-control text_box">
									</gr:textfield>
								</div>
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="button" value="Refresh" class="button"
									onclick="fetchCurrencyStaticData()" />
							...
							<div class="row page_content">
								...
								<div class="form-group">
									...
									<table border="1px" align="left">
										<tbody>
											<tr>
												<th align="left" style="width: 400px; padding: 4px 5px;">Currency
												</th>
											...
											<c:if test="${not empty staticDataList}">
												...
												<gr:iterator value="staticDataList" var="staticDataList">
													<tr class="currencyList" ondblclick="selectCurrency(this)">
														...
														<td style="padding: 4px 5px;">
															<div class="form-group" align="left">
																<gr:property value="currencyFullName" />
																<div class="col-md-8 input-group input-group-md"></div>
															</div>
														</td>
