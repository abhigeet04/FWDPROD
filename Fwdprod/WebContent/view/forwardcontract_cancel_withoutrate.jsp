...
<head>
<title>Forward Contract Cancellation Without Rate</title>
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="side_nav" style="width: 215px;">
					<ul class="nav nav-pills nav-stacked">
						<li style="text-align: center;"><a href="#"
							onclick="getFWCPostingsToReverseWithoutRate()">View Postings</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-10 content_box">
				<h5 style="font-weight: bold; font-size: 13px; color: #527BB8;">&nbsp;Forward
					Contract Cancellation Without Rate - Maker Process</h5>
				<br /> <br />
						...
						<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-3 input-group input-group-md">
											<gr:textfield id="fwdContractNo"
												...
												onchange="fetchFWCCancelDetailsWithoutRate()" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-md-3 input-group input-group-md">
											<gr:textfield id="bookingDate"
												...
												cssClass="datepicker form-control text_box" readonly="false"
												style="text-align: left;" />
										</div>
									</div>
							...
							<div class="row page_content">
									...
									<div class="form-group">
										...
										<div class="col-md-3 input-group input-group-md">
											<gr:textfield id="bookingrate"
												name="fwdContractVO.bookingrate"
												cssClass="form-control text_box" />
										</div>
									</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;"> Transaction Date
											</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
							...
							<gr:hidden id="screenType" name="fwdContractVO.screenType"
								value="MakerCancelScreenWithoutRate">
							</gr:hidden>
