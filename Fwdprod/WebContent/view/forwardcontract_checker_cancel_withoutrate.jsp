...
<head>
<title>Forward Contract Checker View Without Rate</title>
...
<script>
	...
	function approveFwdContractWithoutRate() {
		...
		if (remarks != '') {
			...
			$('#myForm').attr('action', 'approveFwdContractWithoutRate');
	...
	function rejectFwdContractWithoutRate() {
		...
		if (remarks != '') {
			...
			$('#myForm').attr('action', 'rejectFwdContractWithoutRate');
	...
	$(document).ready(function() {
		...
		$("#deleteBtn").click(function() {
			...
			if (remarks != '') {
				...
				$('#myForm').attr('action', 'deleteFwdContractWithoutRate');
		...
		<div class="row">
				...
				<div class="side_nav" style="width: 215px;">
					<ul class="nav nav-pills nav-stacked">
						<li style="text-align: center;"><a
							href="checkerProcessWithoutRate">Close</a></li>
					</ul>
				</div>
				<br />
			...
			<div class="col-md-10 content_box">
				<h5 style="font-weight: bold; font-size: 13px; color: #527BB8;">&nbsp;Forward
					...
					Contract Cancellation Without Rate - Checker Process</h5>
				<br />
				<br />
				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="page_collapsible" id="body-section-error">
							<span></span>
						...
						<div class="col-md-12">
							...
							<div class="row page_content">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">Cancellation / Utilisation
												Amount</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">Deal Valid To
												&nbsp;&nbsp;</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
							...
							<div class="row page_content">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">Available Limit
												&nbsp;&nbsp;</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
								...
								<div class="col-md-6">
									<!-- Without Limit: pre-checked from maker selection, read-only for checker -->
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">Without Limit
												&nbsp;&nbsp;</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
									...
									<!-- FWC Type: pre-selected from maker, read-only for checker -->
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">FWC Type <span
									...
									<!-- Hidden field to submit fwcType value since disabled radio won't post -->
									<gr:hidden id="fwcTypeHidden" name="fwdContractVO.fwcType" />
								</div>
							</div>
							<!-- Charge Details -->
							<div class="row page_content">
							...
							<div class="row page_content">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: normal;">Instructions
												&nbsp;&nbsp;</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
									...
									<div class="form-group">
										<div class="col-md-5 Control-label">
											<label style="font-weight: bold;">Remarks
												&nbsp;&nbsp;</label>
										</div>
										<div class="col-md-3 input-group input-group-md">
							...
							<div align="center">
								<input style="width: 100px; margin: 100px;" type="button"
									value="Approve" class="button" id="approveBtn"
									onclick="approveFwdContractWithoutRate()" /> <input
									style="width: 100px; margin: 100px;" type="button"
									value="Reject" class="button" id="rejectBtn"
									onclick="rejectFwdContractWithoutRate()" />
							</div>
							<gr:hidden id="screenType" name="fwdContractVO.screenType"
								value="CheckerActionScreenWithoutrate" />
